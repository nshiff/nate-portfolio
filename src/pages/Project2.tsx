  ...
  return (
    <main style={{ flex: 1, padding: '2rem 0' }}>
      <div className="container">
        ...
        <h1 style={{ fontSize: '3rem', marginBottom: '1rem' }}>Project Title 2</h1>
        ...
        <div style={{ color: 'var(--text-secondary)', fontSize: '1.125rem', lineHeight: '1.8', maxWidth: '800px' }}>
          <p style={{ marginBottom: '1.5rem' }}>
            This is the dedicated page for Project 2. Here you can elaborate on the problem you were trying to solve, the technologies you chose, and the challenges you faced during development.
          </p>
          <p>
